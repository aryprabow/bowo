...
wget -O /usr/bin/add-l2tp https://raw.githubusercontent.com/aryprabow/bowo/main/1/add-l2tp.sh && chmod +x /usr/bin/add-l2tp
wget -O /usr/bin/del-l2tp https://raw.githubusercontent.com/aryprabow/bowo/main/1/del-l2tp.sh && chmod +x /usr/bin/del-l2tp
wget -O /usr/bin/add-pptp https://raw.githubusercontent.com/aryprabow/bowo/main/1/add-pptp.sh && chmod +x /usr/bin/add-pptp
wget -O /usr/bin/del-pptp https://raw.githubusercontent.com/aryprabow/bowo/main/1/del-pptp.sh && chmod +x /usr/bin/del-pptp
wget -O /usr/bin/cek-pptp https://raw.githubusercontent.com/aryprabow/bowo/main/1/cek-pptp.sh && chmod +x /usr/bin/cek-pptp
wget -O /usr/bin/renew-pptp https://raw.githubusercontent.com/aryprabow/bowo/main/1/renew-pptp.sh && chmod +x /usr/bin/renew-pptp
wget -O /usr/bin/renew-l2tp https://raw.githubusercontent.com/aryprabow/bowo/main/1/renew-l2tp.sh && chmod +x /usr/bin/renew-l2tp
